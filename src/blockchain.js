...
class Blockchain {
    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (height != -1) {
                const prevBlock = self.chain[height];
            ...
            const thisBlockHash = SHA256(JSON.stringify(block)).toString();
            block.hash = thisBlockHash;
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            const elapsedInMins = (currentTime - timeInMessage) / 60;
            console.log(`ellapsed ${elapsedInMins}`);
            if (elapsedInMins <= 5.0) {
                ...
                reject("more than 5 minutes have passed since message was requested");
            }
        });
    }
    ...
    getBlockByHash(hash) {
        let self = this;
        return new Promise((resolve, reject) => {
            resolve(self.chain.find((item) => item.hash === hash));
        });
    }
